...
const OUT_FILE = path.join(DATA_DIR, "luxurybazaar-latest.json");

const LATEST_URL = "https://raw.githubusercontent.com/chrisevo24/luxury-bazaar-tracker/main/latest.json";
...
async function scrape() {
  console.log("[LuxuryBazaar] Fetching latest inventory...");
  ...
  console.log(`[LuxuryBazaar] Done. ${items.length} in-stock items written.`);
  return items;
}
